...
<script src="<@wp.resourceURL />sd-manage-users/static/js/main.7373e546.chunk.js"></script>
...
<!-- TODO: set the service-url (or urls) when re-implementing the fetchData functionality-->
